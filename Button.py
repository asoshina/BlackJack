...
class Button:
    def __init__(self, width, height):
        self.width = width
        self.height = height
        self.i_color = (23, 204, 58)
        self.a_color = (13, 162, 58)
    ...
    def draw(self, x, y, message, action=None, font_size=30):
        button_sound = pygame.mixer.Sound('Other/button.wav')

        mouse = pygame.mouse.get_pos()  # координаты мышки
        click = pygame.mouse.get_pressed()  # состояние кнопки мышки
    ...
    def draw_beautiful_rect(self, ms_x, ms_y, x, y):
        ...
        pygame.draw.rect(display, self.a_color, (x, draw_y, self.rect_w, self.rect_h))